...
format:
  ...
  pdf:
    ...
    fig-pos: "H"
    header-includes: |
      %% --- Statecraft PDF theme ---
      %% Fonts via fontspec (XeLaTeX/LuaLaTeX)
      \usepackage{fontspec}
      ...
      %% Caption styling
      \usepackage{caption}
      \captionsetup{font={small,it}, labelfont={bf,small}, labelsep=period,
                    skip=6pt, justification=centering}
      \captionsetup[table]{skip=6pt, position=top}
      %% Verdigris heading colour (#3A5648)
      \usepackage{xcolor}
      \definecolor{verdigris}{HTML}{3A5648}
      \definecolor{ink}{HTML}{1C1916}
      \definecolor{slate}{HTML}{6B6357}
      %% Section heading colours via KOMA-script (no titlesec — conflicts with scrartcl)
      \addtokomafont{section}{\color{verdigris}}
      \addtokomafont{subsection}{\color{ink}}
      \addtokomafont{subsubsection}{\itshape\color{ink}}
      \addtokomafont{sectionentry}{\color{ink}}
      ...
      \renewcommand{\headrule}{\hbox to\headwidth{\color{verdigris}\leaders\hrule height \headrulewidth\hfill}}
      \fancyhead[L]{\small\color{slate}\itshape Forecasting Returns in Thin Markets}
      \fancyhead[R]{\small\color{slate}Šagovac · Šikić · Palić}
